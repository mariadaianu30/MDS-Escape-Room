  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 lg:top-6 lg:left-6 p-3 bg-black/80 border-2 border-[#5c4026] text-[#c7baaa] hover:text-[#d4af37] hover:border-[#d4af37] transition-all rounded-lg shadow-[0_0_15px_black] z-[60] flex items-center gap-2 group"
      >
